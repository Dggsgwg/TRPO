...
class TravelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create travel" do
    assert_difference("Travel.count") do
      post travels_url, params: { travel: { date: @travel.date, departure_point: @travel.departure_point, destination: @travel.destination, price: @travel.price } }
    end
  ...
  test "should update travel" do
    patch travel_url(@travel), params: { travel: { date: @travel.date, departure_point: @travel.departure_point, destination: @travel.destination, price: @travel.price } }
